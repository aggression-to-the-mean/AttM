...
Using data science tools such as web scraping, I have obtained a dataset with fight odds information regarding the majority of the UFC fights that occurred between 2013 and present (for code, see [here](https://github.com/rogue-mma/Rogue-MMA/tree/main/Data-Collection)).   
