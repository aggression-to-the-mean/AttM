...
In this post, I identified a couple of the most Under Rated fighters on the UFC roster. By doing the same manual checks as me, you could go down the list of the top 10 overperformers from the data set and calculate the actual UFC Over Performance stats for the fighters not covered in this post.  

I intend calculate the Over Performance stats for additional UFC fighters and ammend this post.  
