...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, fig.path = "rmd_images/2021-04-24-bayesian_logistic_regression_analysis/")
...
Compute predicted bets (note: this is different than predicted outcomes - with predicted bets we see if the predicted probability of victory exceeds the adjusted implied probability of victory of the odds).  
...
Compute actual profit for just picking Favorites, for just picking Underdogs.    
